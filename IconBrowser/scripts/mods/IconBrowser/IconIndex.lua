-- Auto-generated icon index (scanned from Lua string literals)
-- Source match: string literals containing "content/ui/materials/icons/"
-- Normalization: appended "" to matched literals (no extensions found in source)
...
return {
    ...
    "content/ui/materials/icons/contracts/contracts_store/uknown_melee_weapon",
    "content/ui/materials/icons/contracts/contracts_store/uknown_ranged_weapon",
